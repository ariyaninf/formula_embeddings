from src.model_v12_clause_loss import *
...
def init():
    ...
    args_parser.add_argument("--model_path", default='output/v12_clause_loss', type=str)
    args_parser.add_argument("--patience", default=5, type=str)
    args_parser.add_argument("--clause_lambda", default=0.05, type=float)
...
if __name__ == '__main__':
    ...
    # Set parameters
    args = init()
    model_path = os.path.join(args.model_path, 'v12_' + args.bert_version, str(args.max_seq_length),
                              args.dataset + "_" + args.bert_pooling + "_" + args.sent_pooling
                              + "_" + str(args.error_margin) + "_" + str(args.threshold) + "_lambda_"
                              + str(args.clause_lambda))

    if not os.path.exists(model_path):
        os.makedirs(model_path)

    model_params = [str(args.bert_version), "_ordemb_clause_loss"]
    ...
    for epoch in trange(args.epochs, desc="Epoch"):
        ...
        for step, batch in enumerate(tqdm(train_loader, desc="Iteration")):
            ...
            sent_premises = df_sub.sentence1.values
            sent_hypos = df_sub.sentence2.values
            ...
            optimizer.zero_grad()
            loss, preds = model(seq_in1, seq_in2, seq_equ_1, seq_equ_2, tb_labels, use_gpu)
            ...
            del df_sub, seq_in1, seq_in2, seq_equ_1, seq_equ_2, loss
            gc.collect()
        ...
        for step, batch in enumerate(tqdm(val_loader, desc="validation")):
            ...
            v_sent_premises = df_sub.sentence1.values
            v_sent_hypos = df_sub.sentence2.values
            ...
            with torch.no_grad():
                v_loss, v_preds = model(v_seq_in1, v_seq_in2, v_seq_equ_1, v_seq_equ_2, vb_labels, use_gpu)
            ...
            del df_sub, v_seq_in1, v_seq_in2, v_seq_equ_1, v_seq_equ_2, v_loss
            gc.collect()
