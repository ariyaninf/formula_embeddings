...
## Prepare the data
The dataset used in this project can be downloaded [here](https://bit.ly/emb-learning-2024-data). Please download the dataset and extract all the files into the `./dataset/` directory.
