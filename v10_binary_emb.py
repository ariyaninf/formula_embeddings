from src.model_v10_binary_emb import *
...
def init():
    ...
    args_parser.add_argument("--model_path", default='output/v10_binary_embeddings', type=str)
...
if __name__ == '__main__':
    ...
    # Set parameters
    args = init()
    model_path = os.path.join(args.model_path, 'v10_' + args.bert_version, str(args.max_seq_length),
    ...
    # df_val = df_val.drop(columns=['sentence1', 'sentence2'])
