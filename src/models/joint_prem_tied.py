...
class BiEncoder_OrderEmb(torch.nn.Module):
    ...
    def forward(self, token_ids1, input_masks1, token_ids2, input_masks2, labels):
        ...
        emb_premise = self.get_embeddings(token_ids1, input_masks1)
        emb_hypothesis = self.get_embeddings(token_ids2, input_masks2)
    ...
    def get_embeddings(self, token_ids, input_masks):
