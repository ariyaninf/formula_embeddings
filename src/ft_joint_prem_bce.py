...
from src.models.joint_prem_bce import *
...
def init():
    ...
    args_parser.add_argument("--model_path", default='output/v17_joint_prem_bce', type=str)
...
if __name__ == '__main__':
    ...
    # Set parameters
    args = init()
    model_path = os.path.join(args.model_path, 'v17_' + args.bert_version, str(args.max_seq_length),
