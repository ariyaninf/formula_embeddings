...
from src.models.joint_prem import *
...
def init():
    ...
    args_parser.add_argument("--model_path", default='output/v15_joint_prem', type=str)
...
if __name__ == '__main__':
    ...
    # Set parameters
    args = init()
    model_path = os.path.join(args.model_path, 'v15_' + args.bert_version, str(args.max_seq_length),
